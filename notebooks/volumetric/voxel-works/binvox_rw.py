...
#
## Note from me after coppying the source code from its githubpage in here:
## I'm using a newer version of numpy so I had to change np.int to np.int32
## and np.bool to np.bool_.
"""
